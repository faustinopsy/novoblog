...
class LiveSearch {
  ...
  var $baseurl = "http://localhost/novoblog/";
  ...
  var $errorToShort = '<div class="alert alert-error alert-danger">Você tem que entrar pelo menos %1$s Caracteres.</div>';   //minlength
  //error message for to small search term
  var $errorNothingFound = '<div class="alert alert-info">Nenhum resultado para %1$s.</div>';   //%1$s ... searchstring
  //info message for no search term
  var $infoNoSearchTerm = '<div class="alert alert-info">Por favor, digite qualquer termo que você gostaria de pesquisar.</div>';
  //HTML Tags stripped from search query
  var $errorStrippedTags = '<div class="alert alert-error alert-danger">As tags foram removidas da sua consulta de pesquisa<br />HTML-Tags não têm permissão para pesquisar.</div>';


  //if you're running into performance-troubles (timeout during caching, memory exhausted ...)
  //var $performance_fix = true;
  var $performance_fix = true;   // true if you've got troubles, false if everything is working fine :) (default)
  ...
  var $img_results_headline = '%2$s Imagens para %1$s';  //used for the imagesearchresults (more images) -> Number of images, Searchstring
  //var $img_results_headline = '%1$s Bilder f&uuml;r %2$s';  //Number of images, Searchstring
  var $img_result_headline = '1 Imagem para %1$s';  //used for the imagesearchresults (one image) -> Searchstring
